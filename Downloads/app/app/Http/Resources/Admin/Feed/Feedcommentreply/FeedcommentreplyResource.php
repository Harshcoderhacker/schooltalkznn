...
class FeedcommentreplyResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'is_feedpostcommentreplyedit' => ((auth()->user()->usertype == 'ADMIN') ? true : (($this->feedcommentreplyable->uuid == auth()->user()->uuid) ? true : false)),
