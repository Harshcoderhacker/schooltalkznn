...
class Staffcreateonlineassessmentlivewire extends Component
{
    public $questionmodel = false;
    public $configuremodal = false;
    public $assignsubject, $user;
    ...
    public function render()
    {
        ...
        return view('livewire.staff.exam.onlineassessment.staffcreateonlineassessmentlivewire');
    }
}
