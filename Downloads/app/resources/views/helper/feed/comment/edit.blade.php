...
<div
    ...
    <div class="bg-white rounded-lg dark:bg-gray-700 w-full max-w-lg shadow-2xl">
        ...
        <div class="p-6 space-y-6">
            <div>
                <label for="feedcommentedit" class="form-label font-medium">Comment</label>
                <textarea autocomplete="off" wire:model.lazy="feedcommentedit" name="feedcommentedit"
                    id="feedcommentedit" type="text" class="form-control" rows="5" style="resize:none;"
                    placeholder="Share your thoughts over here. Get to know your peers opinions">
                        </textarea>
                @error('feedcommentedit') <span class="font-semibold text-red-600 mt-2">{{ $message
                    }}</span>
                @enderror
            </div>
        </div>
        <div
            ...
            <button wire:click="updatepostcomment({{$feedcommenteditid}})" class="btn btn-primary">Update</button>
        </div>
    </div>
</div>