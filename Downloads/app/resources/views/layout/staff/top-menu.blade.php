...
@section('content')
    @include('../layout/staff/components/mobile-menu')
    <!-- BEGIN: Top Bar -->
    <div class="border-b border-white/[0.08] -mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10">
        <div class="top-bar-boxed flex items-center">
            <!-- BEGIN: Logo -->
            <a href="" class="-intro-x hidden md:flex">
                <img alt="Edfish School ERP Software" class="w-6" src="{{ asset('dist/images/logo.svg') }}">
                    ...
                    <div class="search-result__content">
                        ...
                        <div class="mb-5">
                            <a href="" class="flex items-center">
                                <div class="w-8 h-8 bg-primary8 text-theme-9 flex items-center justify-center rounded-full">
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div
                                    class="w-8 h-8 bg-primary7 text-theme-11 flex items-center justify-center rounded-full">
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div
                                    class="w-8 h-8 bg-primary4 text-theme-10 flex items-center justify-center rounded-full">
                            ...
                            <div class="cursor-pointer relative flex items-center {{ $key ? 'mt-5' : '' }}">
                                ...
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;"
                                            class="font-medium truncate mr-5">{{                                             class="font-medium truncate mr-5">$faker['users'][0]['name'] }}</a>
            ...
            <div class="intro-x dropdown w-8 h-8">
                <div class="dropdown-tw-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110"
                    role="button" aria-expanded="false">
                    <img alt="{{ auth()->user()->name }}" src="{{ asset('dist/images/' . $fakers[9]['photos'][0]) }}">
                </div>
                <div class="dropdown-menu w-56">
                    <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                        <div class="p-4 border-b border-theme-27 dark:border-dark-3">
                            <div class="font-medium">{{ $fakers[0]['users'][0]['name'] }}</div>
                            <div class="text-xs text-theme-28 mt-0.5 dark:text-gray-600">{{ $fakers[0]['jobs'][0] }}
                            </div>
                        </div>
                        <div class="p-2">
                            <a href=""
                                class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-primary dark:hover:bg-dark-3 rounded-md">
    ...
    <nav class="top-nav">
        <ul>
            @foreach ($staff_top_menu as $menuKey => $menu)
                <li>
