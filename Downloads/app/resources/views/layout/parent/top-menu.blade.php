...
@section('content')
@include('../layout/parent/components/mobile-menu')
<!-- BEGIN: Top Bar -->
    ...
    <div class="top-bar-boxed flex items-center">
        ...
        <div class="intro-x dropdown w-8 h-8">
            <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110"
                role="button" aria-expanded="false">
                <img alt="Edfish School ERP Software" src="{{ asset('dist/images/' . $fakers[9]['photos'][0]) }}">
            </div>
...
<nav class="top-nav">
    <ul>
        @foreach ($parent_top_menu as $menuKey => $menu)
        <li>
