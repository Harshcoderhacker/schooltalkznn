...
@section('breadcrumb')
    ...
    @include('helper.breadcrumb.breadcrumb', ['flag'=> 'active', 'name' => 'Create Class Group'])
@endsection
            ...
            <div class="px-5 sm:px-20 mt-3 pt-3 border-t border-gray-200 dark:border-dark-5 border-none">
                <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                    <div class="intro-x col-span-12 mx-auto mb-3">
                        <h1 class="text-theme-1 text-2xl font-semibold">Create Class Group</h1>
                    </div>
                    <div class="intro-x col-span-12 sm:col-span-12">
                        <label for="input-wizard-1" class="form-label font-semibold">Class Group</label>
                    ...
                    <div class="intro-x col-span-12 sm:col-span-6">
                        <label for="input-wizard-3" class="form-label font-semibold">Subject</label>
                        <input id="input-wizard-3" type="text" class="form-control">
                    </div>
