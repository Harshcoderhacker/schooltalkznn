...
<div class="intro-y box px-5 pt-5 mt-5">
    ...
    @include('admin.staff.staffinfotabhelper.staffinfotabhelper',['activestatus' =>'documents'])
    @livewire('admin.staff.staffinfo.staffdocumentsinfolivewire',compact('staff'))
</div>
<!-- END: Profile Info -->
@endsection
