        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="{{ URL('/') }}" class="-intro-x flex items-center pt-5">
                    <img alt="Edfish School ERP Software" class="w-24" src="{{ asset('/image/logo/white_logo.png') }}">
                ...
                <div
                    ...
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            ...
                            <div id="error-phone" class="login__input-error w-5/6 text-theme-6 mt-2"></div>
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-center">
                        <button id="btn-login"
                            class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top text-center">Login</button>
    ...
    <script>
        cash(function() {
            async function login() {
                ...
                axios.post(`postadminlogin`, {
                    phone: phone,
                    password: password,
                    remember_me: rememberMe
                }).then(res => {
                    location.href = '/admin/dashboard/admindashboard'
                }).catch(err => {
                    cash('#btn-login').html('Login')
                    if (err.response.data.message != 'Wrong phone or password.') {
