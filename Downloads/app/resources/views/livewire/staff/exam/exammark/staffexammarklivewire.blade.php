                                    ...
                                    @foreach ($eachexam->examsubject as $eachsubject)
                                        <tr class="intro-x">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                ...
                                                <a href="{{ route('staffviewmark', ['examid' => $eachsubject->exam_id,'subjectid' => $eachsubject->subject_id,'classmasterid' => $classmaster_id,'sectionid' => $section_id]) }}"
                                                    type="button"
                                            ...
                                            @endif
                                            @if ($eachsubject->mark_status)
                                                <a href="{{ route('staffdomarkentry', ['examid' => $eachsubject->exam_id,'subjectid' => $eachsubject->subject_id,'classmasterid' => $classmaster_id,'sectionid' => $section_id]) }}"
                                                    type="button"
