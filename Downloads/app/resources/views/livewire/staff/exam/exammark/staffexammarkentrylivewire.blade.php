<div>
    <div class="col-span-12 mt-8">
                                ...
                                @foreach ($studentlist as $key => $eachstudentmarklist)
                                    <div>
                                        <tr class="intro-x">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div>
                                                    @livewire('staff.exam.exammark.staffexammarkvalueentrylivewire',
        ...
        <div class="flex flex-row mt-5 intro-y justify-end">
            <a href="{{ route('staffmarkentry') }}" class="btn btn-danger">Cancel and Go Back</a>
            <a href="{{ route('staffmarkentry') }}" class="btn btn-primary mx-4">Save</a>
        </div>
    </div>
