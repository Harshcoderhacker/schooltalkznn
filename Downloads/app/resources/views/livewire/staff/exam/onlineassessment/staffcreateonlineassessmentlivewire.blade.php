<div>
            ...
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="intro-y box p-5 mt-12 sm:mt-5 mx-5 shadow py-4">
                    <select class="form-select w-full mt-2" wire:model="class_id">
                        ...
                        @foreach ($assignsubject->unique('classmaster_id') as $eachassignsubject)
                            <option value={{ $eachassignsubject->classmaster_id }}>
                                {{ $eachassignsubject->classmaster->name }}
                            </option>
                        @endforeach
                    </select>
                    <select class="form-select w-full mt-4" wire:model="subject_id">
                        <option value=null>Select Subject </option>
                        @foreach ($assignsubject->unique('subject_id') as $eachassignsubject)
                            <option value={{ $eachassignsubject->subject_id }}>
    ...
    @endif
    @if ($configuremodal)
        @livewire('staff.exam.onlineassessment.staffconfigureonlineassessmentlivewire',['assessmenttemplate'=>$assessmenttemplate,
