<div>
    <div class="intro-y chat grid grid-cols-12 gap-5 mt-5 mb-12">
        @include('admin.settings.feedsettings.helper.feedsettingsmenu', [
            'active' => 'feedstaffidealibrary',
        ])
        <div class=" col-span-12 xl:col-span-12">
            <div class="p-2">
                <div class="grid grid-cols-12 gap-1">
                    @include('helper.datatable.header', [
                        'title' => 'Staff Idea Library',
                        'search' => 'searchTerm',
                    ])
                    ...
                    <!-- BEGIN: Data List -->
                    @if ($staffidealibrary->isNotEmpty())
                        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                            <table class="table table-report -mt-2">
                                ...
                                <tbody>
                                    @foreach ($staffidealibrary as $index => $value)
                                        <tr class="intro-x">
    ...
    @include('livewire.admin.settings.feed.feedidealibrary.feedstaffidealibraryshow')
</div>
