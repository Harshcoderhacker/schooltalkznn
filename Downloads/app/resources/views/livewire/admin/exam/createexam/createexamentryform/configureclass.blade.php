    ...
    <div
        ...
        <form wire:submit.prevent="validateconfigureclass" autocomplete="off">
            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                ...
                <div class="intro-x col-span-12 gap-4 sm:col-span-2">
                    <input wire:model="is_main_exam" class="form-check-input" type="checkbox"
                        {{ $is_main_exam ? 'checked' : '' }}>
                    <label for="input-wizard-3" class="form-label">Main Exam</label>
                </div>
                <div class="intro-x col-span-12 flex items-center justify-center sm:justify-end mt-5 mb-5">
                    <a href="{{ route('admincreateexamindex') }}" class="btn btn-danger w-24">Cancel</a>
