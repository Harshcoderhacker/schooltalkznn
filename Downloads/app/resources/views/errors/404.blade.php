...
<head>
    ...
    <title>Edfish 404</title>
</head>

<body>
    <div class="h-screen mx-auto bg-gray-100 flex items-center text-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700 mx-auto">
            <div class="max-w-md">
                ...
                <a href="{{route('homeloginpage')}}"
                    class="px-4 inline py-2 text-sm font-medium leading-5 shadow transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg- active:bg- hover:bg-blue-700">back
                    to homepage</a>
            </div>
            <div class="max-w-lg">
