<div>
    <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:float-right">
        <div class="relative text-gray-700 dark:text-gray-300">
            <a href="{{ route('staffcreateexam') }}" class="btn btn-primary w-40 ml-2">New Examination +</a>
        </div>
    </div>
                                    ...
                                    <tr class="intro-x">
                                        ...
                                        <td class="whitespace-nowrap text-center">
                                            <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-content">
                                                        <li class="px-3">
                                                            <div class="flex justify-center gap-2 items-center">
                                                                <a href="{{ route('staffeditexam', ['exam' => $eachexam->id, 'show' => 1]) }}"
                                                                    class="
                                                ...
                                                <li>
                                                    <div data-tw-dismiss="dropdown" class="dropdown-item justify-center"
                                                        wire:click="openexamstatusmodal({{ $eachexam->id }})">
                                                        View Exam Status
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none" stroke="cyan"
                                                            stroke-width="4" stroke-linecap="round"
                                                            stroke-linejoin="round" class="feather feather-circle ml-2">
                                                ...
                                                <li>
                                                    <div data-tw-dismiss="dropdown" class="dropdown-item justify-center"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            ...
                                                            stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" class="feather feather-edit ml-2">
                                                            <path
                                                                d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7">
                                                            </path>
                                                            <path
...
@if ($showexamdetailsmodal)
    <div class="right-0 left-0 justify-end h-screen inset-0 fixed overflow-auto bg-smoke-dark flex animate__animated animate__fadeInLeftBig"
        style="z-index:52;">
        <div type="button" wire:click="closeexamdetailsmodal" class="absolute inset-0 bg-gray-500 opacity-75">
        </div>
        <div class="relative md:w-2/5 w-full">
            <div class="relative bg-white rounded h-screen shadow dark:bg-gray-700">
                ...
                <div class="p-4">
                    <div class="intro-y flex bg-amber-500 rounded justify-between items-center h-18 mt-2">
                        <div>
                            <h2 class="text-lg font-medium truncate mr-5 p-5">{{ $examdetails->name }}</h2>
                        </div>
                        <div>
...
@if ($showexamstatusmodal)
    <div class="right-0 left-0 justify-end h-screen inset-0 fixed overflow-auto bg-smoke-dark flex animate__animated animate__fadeInLeftBig"
        style="z-index:52;">
        <div type="button" wire:click="closeexamstatusmodal" class="absolute inset-0 bg-gray-500 opacity-75">
        </div>
        <div class="relative md:w-2/5 w-full">
            <div class="relative bg-white rounded h-screen shadow dark:bg-gray-700">
                <div class="flex justify-between items-center bg-primary p-4 rounded-t border-b dark:border-gray-600">
                                ...
                                @else
                                    ...
                                    <div class="font-semibold">
                                        @if ($eachexamsubject->examdate == $today)
                                            <a href="{{ route('staffmarkexamattendance', ['examid' => $eachexamsubject->exam_id, 'subjectid' => $eachexamsubject->subject_id, 'classmasterid' => $classmaster_id, 'sectionid' => $section_id]) }}"
                        ...
                        <div class="flex flex-row justify-center">
                            ...
                            <div
                                ...
                                @if ($eachexamsubject->mark_status)
                                    <div class="font-semibold text-gray-700">
                                        Mark Entry Done on {{ $eachexamsubject->mark_updated_at->format('d-M-Y') }}
                                    </div>
                                    <div class="font-semibold text-gray-700">
                                        View Marks
                                    </div>
                                @else
                                    ...
                                    <div class="font-semibold">
                                        @if ($eachexamsubject->attendance_status)
                                            <a href="{{ route('staffdomarkentry', ['examid' => $eachexamsubject->exam_id, 'subjectid' => $eachexamsubject->subject_id, 'classmasterid' => $classmaster_id, 'sectionid' => $section_id]) }}"
