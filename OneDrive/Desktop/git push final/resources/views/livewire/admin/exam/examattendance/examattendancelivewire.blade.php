<div>
    <div class="intro-y flex items-center h-10 mt-3">
        <h2 class="text-lg font-medium truncate mr-5">Search Exam Attendance</h2>
    </div>
                                        ...
                                        <tr class="intro-x">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                ...
                                                @if ($eachsubject->attendance_status)
                                                    <a href="{{ route('markexamattendance', ['examid' => $eachsubject->exam_id, 'subjectid' => $eachsubject->subject_id]) }}"
                                                        type="button"
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <button
                                                            ...
                                                            title="Attendance not Available till Exam Date">Take
                                                            Attendance</button>
                                                    @endif
                                                @endif
                                            </td>
