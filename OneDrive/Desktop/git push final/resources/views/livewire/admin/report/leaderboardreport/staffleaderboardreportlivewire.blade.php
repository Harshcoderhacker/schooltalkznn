    ...
    <div class="w-full mx-auto ">
        <div class="col-span-12 mt-5">
            <div class="intro-y flex items-center h-10">
                <h2 class="text-lg truncate mr-5">Staff Leaderboard</h2>
            </div>
        ...
        <div class="grid grid-cols-12 mt-8 justify-around gap-8">
            @if($acadamicmonthid!='' && $staffleaderboard)
                    ...
                    <div
                            ...
                            <div>
                                ...
                                <span class="text-xl font-semibold">
                                    {{$staffleaderboard->sum('post_count')}}
                                </span>
                            </div>
                            <div>
                                <span class="text-green-500">Achievements</span><br>
                                <span
                                    class="text-xl font-semibold">{{$staffleaderboard->sum('achievement_count')}}</span>
                                </span>
                            </div>
                            <div>
                                ...
                                <span
                                    ...
                                    {{$staffleaderboard->sum('poll_count')}}
                                </span>
                            </div>
                            <div>
                            ...
                            <div class="py-2 align-middle inline-block min-w-full">
                                <div class="overflow-hidden">
                                    ...
                                    <table class="table table-report -mt-2">
                                       ...
                                       <tbody>
                                            @foreach($staffleaderboard as $key=>$eachstaff)
                                                <tr>
                                                    <td>
                                                        {{$eachstaff->name}}
                                                    </td>
                                                    <td>
                                                        {{$eachstaff->post_count}}
                                                    </td>
                                                    <td>
                                                        {{$eachstaff->achievement_count}}
                                                    </td>
                                                    <td>
                                                        {{$eachstaff->poll_count}}
                                                    </td>
                                                    <td>
            ...
            @elseif($acadamicmonthid!='' && sizeof($staffleaderboard)==0)
            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center p-10 box mt-4 bg-blue-100 leading-6">
                <div class="mx-auto flex flex-row items-center">
                    <div>
                        ...
                        <p class="text-2xl mt-2 font-bold text-gray-900 dark:text-gray-100 dark:text-white mr-5">to view staff leaderboard</p>
                    </div>
                    <div>
