    ...
    <div class="w-full mx-auto ">
        <div class="col-span-12 mt-5">
            <div class="intro-y flex items-center h-10">
                <h2 class="text-lg truncate mr-5">Mark Sheet Report</h2>
            </div>
        ...
        <div class="grid grid-cols-12 mt-8 ml-10 justify-around gap-8">
                                        ...
                                        <tr class="intro-x">
                                            ...
                                            <td>
                                                <span class="text-sm font-medium text-center text-theme-11">
                                                    @if(sizeof($examsubjectmark->where('exam_id', $exam[0]->id)->where('is_present',1))>0)
            ...
            @elseif($classmasterid && $sectionid && $examid && $studentid && $exam->isEmpty())
                ...
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center p-10 box mt-4 bg-blue-100 leading-6">
                    <div class="mx-auto flex flex-row items-center">
                        <div>
                            ...
                            <p class="text-2xl mt-2 font-bold"> <span class="text-green-500">Class, Section, Exam and Student</span></p>
                            <p class="text-2xl mt-2 font-bold text-gray-900 dark:text-gray-100 dark:text-white mr-5">to view marksheet</p>
                        </div>
                        <div>
