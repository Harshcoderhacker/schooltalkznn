            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        @include('helper.show.show', [
                            'label' => 'CATEGORY',
                            'value' => $idealibraryshowdata->idea_category
                                ? config('archive.idea_category')[$idealibraryshowdata->idea_category]
                                : '',
                        ])
                        @include('helper.show.show', [
                            'label' => 'Classes',
                            'value' => $idealibraryshowdata->classmaster->pluck('name')->implode(','),
                        ])
