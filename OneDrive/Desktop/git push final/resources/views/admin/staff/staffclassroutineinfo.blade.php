...
<div class="intro-y box px-5 pt-5 mt-5">
    ...
    @include('admin.staff.staffinfotabhelper.staffinfotabhelper',['activestatus' =>'classroutine'])
    @livewire('staff.classroutine.classroutinestafflivewire',['staff_id' => $staff->id])
</div>
<!-- END: Profile Info -->
@endsection
