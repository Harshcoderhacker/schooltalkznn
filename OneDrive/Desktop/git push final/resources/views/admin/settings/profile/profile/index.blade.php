...
@section('breadcrumb')
    ...
    @include('helper.breadcrumb.breadcrumb', ['flag'=> 'active', 'name' => 'Profile'])
@endsection
...
@section('subcontent')
    <div class="intro-y chat grid grid-cols-12 gap-5 mt-5 mb-12">
        ...
        @include('admin.settings.profile.helper.profilesettingsmenu', ['active' => 'profile'])
        @livewire('admin.settings.profile.profilelivewire')
        {{-- Toaster --}}
