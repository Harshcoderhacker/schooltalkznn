...
<div class="intro-y box px-5 pt-5 mt-5">
    ...
    @include('admin.student.studentdetailstab.studentsdetailstabhelper',['activestatus' =>'attendance'])
    @livewire('admin.student.studentattendancedetailslivewire',compact('student'))
@endsection
