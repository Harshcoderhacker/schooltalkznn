...
<div class="intro-y box px-5 pt-5 mt-5">
    ...
    @include('admin.student.studentdetailstab.studentsdetailstabhelper',['activestatus' =>'progress'])
    @livewire('admin.student.studentprogressdetailslivewire',compact('student'))
@endsection
