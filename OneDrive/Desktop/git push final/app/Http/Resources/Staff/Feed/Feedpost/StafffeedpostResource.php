...
namespace App\Http\Resources\Staff\Feed\Feedpost;

use App\Http\Resources\Staff\Feed\Feedpoll\StafffeedpollResource;
use Illuminate\Http\Resources\Json\JsonResource;
use Illuminate\Support\Str;

class StafffeedpostResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'poll' => (sizeof($this->feedpoll) == 0) ? [] : StafffeedpollResource::collection($this->feedpoll),
