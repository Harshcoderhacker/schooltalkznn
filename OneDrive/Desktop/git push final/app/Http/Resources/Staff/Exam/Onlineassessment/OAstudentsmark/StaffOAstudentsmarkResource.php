...
use App\Http\Resources\Staff\Exam\Onlineassessment\OAstudentsmark\StaffOAstudentanswerResource;
use App\Models\Admin\Settings\Examsetting\Exampasspercentage;
use Illuminate\Http\Resources\Json\JsonResource;

class StaffOAstudentsmarkResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'result' => $result,
            'answer_details' => StaffOAstudentanswerResource::collection($this->onlineassessmentstudentanswer),
        ];
    }
}
