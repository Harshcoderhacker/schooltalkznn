...
class Staffexamattendancelivewire extends Component
{
    public $user, $today;
    public $classmaster_id, $section_id, $exam_id, $academicyear_id;
    public $classteacher, $exam_info, $examsubject, $exam = [];
    ...
    public function render()
    {
        ...
        return view('livewire.staff.exam.examattendance.staffexamattendancelivewire', compact('examlist'));
    }
}
